...
CHANGED = []
WHOLE = [".aegis/reviews/ga-ecwh-layout-20260908/review-plan.md",".aegis/reviews/ga-ecwh-layout-20260908/inventory.json",".aegis/reviews/ga-ecwh-layout-20260908/source-context.md"]
CONTEXT = []
EVIDENCE = []
...
Review the questions in review-plan.md, prioritizing concrete correctness and preservation
...
'''
    ...
    args = [str(exe), '-p', '--name', 'ga-ecwh.1 layout relocation design review',
