...
| Audit baseline | all tracked test source | subprocess: 555 calls / 169 files (historical regex census: 495 / 135) | ga-80po0c.2 | tracked test source totals remain visible as audit evidence; ga-80po0c.2 owns this point-in-time source census | P0.4a | 2026-10-01 |
...
| Medium owner | `scripts` package `scripts_test` | TestNativeDependencyGuard: subprocess | ga-tmgr | native dependency guard protocol proof is a checked Medium owner; the one shell subprocess site is confined to TestNativeDependencyGuard with disposable roots and a closed fake Go protocol | dependency-guard-regression | 2026-10-01 |
...
| Source debt ratchet | all untagged test source | subprocess: 407 calls / 114 files (historical regex census: 380 / 98) | ga-80po0c.2 | untagged subprocess call/file totals cannot grow; reductions must lower this baseline; each process-owning test removes or replaces its source call site | D1/D2/D5/D6/E6 | 2026-10-01 |
