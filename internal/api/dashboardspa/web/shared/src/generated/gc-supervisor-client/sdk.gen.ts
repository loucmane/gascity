...
/**
 * Post v0 city by city name platform metadata lease begin
 */
export const postV0CityByCityNamePlatformMetadataLeaseBegin = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNamePlatformMetadataLeaseBeginData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNamePlatformMetadataLeaseBeginResponses, PostV0CityByCityNamePlatformMetadataLeaseBeginErrors, ThrowOnError>({
...
/**
 * Post v0 city by city name platform metadata lease check
 */
export const postV0CityByCityNamePlatformMetadataLeaseCheck = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNamePlatformMetadataLeaseCheckData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNamePlatformMetadataLeaseCheckResponses, PostV0CityByCityNamePlatformMetadataLeaseCheckErrors, ThrowOnError>({
